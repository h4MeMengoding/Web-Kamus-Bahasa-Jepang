...
const NotFound = () => {
    return(
        <div className="flex flex-col mx-8 lg:mx-32 lg:mr-52 my-6 lg:my-12 space-y-4 lg:space-y-8">
            ...
            <h1 className="font-bold text-xl text-center lg:text-6xl">Maaf, halaman ini tidak tersedia.</h1>
            <p className="font-bold text-sm text-center lg:text-xl">Yahhh tidak dapat menemukan apa yang Anda cari.<span className="block">Mungkin Anda harus kembali ke halaman utama.</span></p>
