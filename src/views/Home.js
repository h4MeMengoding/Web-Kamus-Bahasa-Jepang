...
import gatau from '../assets/gatau.svg';
import depan from '../assets/depan.svg';
        ...
        <div className="mx-1 lg:mx-32 lg:mr-52">
            <Fade bottom>
                <section className="flex flex-col lg:flex-row lg:mt-12 p-2 lg:p-8 rounded-lg">
                        <div className="flex mx-auto mb-6 lg:mb-0 lg:order-last w-11/12 lg:w-2/5">
                            <img className="mx-auto" src={depan} alt="illustration" width="400"/>
                        </div>
                        <div className="flex flex-col content-start text-center lg:text-left w-11/12 lg:w-3/5 mx-auto">
                            ...
                            <p className="text-base lg:text-2xl mt-4 mb-6 lg:mt-8 dark:text-gray-200 w-10/12 lg:leading-normal mx-auto lg:mx-0">Zerohero adalah situs web yang menyediakan kamus dan pack untuk membantu semua orang belajar bahasa Jepang.</p>
                            <ButtonInstalPWA/>
                        </div>
                </section>
            </Fade>
            <Fade bottom>
                <section className="flex flex-col m-8">
                    <h1 className="animate-bounce block text-4xl text-center font-black font-head uppercase my-4">Bagaimana caranya?</h1>
                    ...
                    <div className="flex flex-col lg:flex-row gap-8">
                        <div className="mx-auto order-last lg:order-first">
                            <img src={gatau} alt="" width="300"/>
                        </div>
                        <div className="mx-auto text-lg my-auto space-y-4">
                            <p>Berikut beberapa contoh untuk mencari kata atau kanji.</p>
