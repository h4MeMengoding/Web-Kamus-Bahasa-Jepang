        ...
        <footer className="flex flex-col bg-gray-100 dark:bg-gray-900 dark:text-white pt-8 pb-4 ">
            {/* <div className="grid grid-cols-12 mx-8 lg:mx-32">
                <div className="col-span-12 lg:col-span-3 mb-4 lg:mb-8">
                    ...
                    <p className="text-center text-base lg:text-medium lg:text-left w-60 lg:w-52 mx-auto">Zerohero is website platform for everyone to learn Japanese.</p>
                </div>
                <div className="grid grid-cols-3 lg:grid-cols-3 col-span-12 lg:col-span-9 space-y-0 mt-5 lg:mt-0 lg:ml-20 text-center lg:text-left">
                    <FooterChild title={'Navigasi'} data={navLinks}/>
                    <FooterChild targetBlank title={'Sosial'} data={socialMedia}/>
                    <FooterChild targetBlank title={'Dev gntg'} data={me}/>
                </div>
            </div> */}
            <div className="flex flex-col lg:flex-row text-center lg:text-left text-sm space-y-4 lg:space-y-0 mb-32 mt-6 mx-8 lg:mb-0 lg:mx-44">
                <span className="">
                    ...
                    <a className="hover:text-primary border-dashed border-b-2 border-gray-900 dark:border-gray-50 hover:border-primary dark:hover:border-primary" href="https://ilhamshf.space" target="_blank" rel="noreferrer">ilhamshf </a> 
                </span>
                <span className="">
                    <span>Helper database by </span>
                    <a className="hover:text-primary border-dashed border-b-2 border-gray-900 dark:border-gray-50 hover:border-primary dark:hover:border-primary" href="https://herohero.hamsh.me" target="_blank" rel="noreferrer">shely </a> 
                </span>
